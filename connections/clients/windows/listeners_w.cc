...
ConnectionListenerW::ConnectionListenerW()
    : pImpl(std::unique_ptr<connections::ConnectionListener,
...
DiscoveryListenerW::DiscoveryListenerW()
    : pImpl(new connections::DiscoveryListener()) {
...
PayloadListenerW::PayloadListenerW()
    : pImpl(std::unique_ptr<connections::PayloadListener,
