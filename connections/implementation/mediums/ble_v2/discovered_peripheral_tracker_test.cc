...
class DiscoveredPeripheralTrackerTest : public testing::Test {
 public:
  ...
  void FindFastAdvertisement(
      ...
      const ByteArray& advertisement_header_bytes,
...
TEST_F(DiscoveredPeripheralTrackerTest,
  ...
  FindFastAdvertisement(advertisement_data, advertisement_header_bytes, {},
                        fetch_latch);
...
TEST_F(DiscoveredPeripheralTrackerTest,
  ...
  FindFastAdvertisement(advertisement_data, advertisement_header_bytes,
                        {advertisement_bytes}, fetch_latch);
...
TEST_F(DiscoveredPeripheralTrackerTest,
  ...
  FindAdvertisement(advertisement_data, advertisement_header_bytes,
                    {advertisement_bytes}, fetch_latch);
...
TEST_F(DiscoveredPeripheralTrackerTest,
  ...
  FindAdvertisement(advertisement_data, advertisement_header_bytes,
                    {legacy_advertisement_bytes}, fetch_latch);
