...
class DiscoveredPeripheralTracker {
 public:
  ...
  // peripheral         - To access the status of the operation. It is mutal
  //                    - parameter that can be modified during the cycle of
  //                      found, like the psm value or the advertisement bytes.
 ...
 private:
  ...
  // service IDs.
  ByteArray CreateDummyAdvertisementHeaderBytes(
      const BleV2Peripheral& peripheral) ABSL_EXCLUSIVE_LOCKS_REQUIRED(mutex_);
