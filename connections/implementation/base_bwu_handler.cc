...
// A suffix appended to service IDs when initiating an upgrade to distinguish
// the mediums from those used for advertising/discovery.
...
const char* BaseBwuHandler::GetUpgradePostfixForTesting() {
  return kInitiatorUpgradeServiceIdPostfix.data();
}
